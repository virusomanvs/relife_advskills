...
```
## HealthRegenPerkConfigList - Настройка списка заготовленных перков которые отвечают за увеличенный реген здоровья. При их активации, ванильные значения восстановления здорровья будут помножены на те что указаны в конфиге при активированном перке
