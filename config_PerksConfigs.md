...
Вы можете создать множество перков в конфиге с перками и указать их здесь чтобы тонко влиять на расход калорий. По умолчанию созданы 3 перка, но вы этим не ограничены.
