...
Также! Перк с ID -1 в параметрах отвечает за выкарывание по умолчанию, без активированных перков.
