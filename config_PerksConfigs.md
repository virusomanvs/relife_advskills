...
- **`Any, BoneBait, Bait`**: `string` Класснеймы крючков, для которых настраивается шанс на поимку рыбы или предмета. ВНИМАНИЕ! Чем меньше значение, тем больше шанс что вы
```json
[
