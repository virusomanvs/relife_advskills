...
### Памятка! Учитывая шансы и удочки, в массиве всегда должен быть предмет который будет выдан в случае если все шансы не сработают. Его необходимо разместить в конце массива. Можете добавить туда бумаку либо палку. 
